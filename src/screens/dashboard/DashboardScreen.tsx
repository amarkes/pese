    ...
    <SafeAreaView className="flex-1 bg-background dark:bg-background-dark" edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 px-5 pt-4">
        ...
        <View className="flex-row items-end justify-between mb-6">
          <Typography variant="h2" className="text-2xl font-inter-bold">{t('dashboard.todaySummary')}</Typography>
          <TouchableOpacity>
            <Typography variant="caption" className="text-primary font-inter-semibold">{t('common.viewDetails')}</Typography>
          </TouchableOpacity>
        </View>
          ...
          <View className="flex-1">
            <Card className="p-5 h-44 justify-between">
              ...
              <View className="mt-4">
                ...
                <View className="flex-row items-baseline">
                  <Typography variant="h2" className="text-2xl font-inter-bold mr-1">92</Typography>
                  <Typography variant="caption" className="text-xs font-inter-medium">mg/dL</Typography>
                </View>
        ...
        <Card className="mb-8 p-6">
          <View className="flex-row items-center justify-between mb-4">
            <View>
              ...
              <View className="flex-row items-center">
                <Typography variant="h2" className="text-3xl font-inter-bold mr-3">75.5 kg</Typography>
                <Typography variant="caption" className="text-emerald-500 font-inter-bold">-0.3%</Typography>
              </View>
            </View>
