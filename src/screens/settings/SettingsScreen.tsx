...
const SettingsScreen: React.FC = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      {/* Header */}
      <View className="flex-row items-center px-6 py-4 border-b border-slate-50 justify-between">
      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1 px-6 pt-6">
        ...
        <View className="mb-6">
          ...
          <View className="bg-slate-50 border border-slate-100 rounded-2xl flex-row items-center px-4 h-16">
            <Text className="flex-1 text-lg font-inter-medium text-text">75.5</Text>
        ...
        <View className="flex-row gap-4 mb-6">
          <View className="flex-1">
            ...
            <View className="bg-slate-50 border border-slate-100 rounded-2xl flex-row items-center px-4 h-16">
                <Text className="flex-1 text-lg font-inter-medium text-text">70</Text>
          ...
          <View className="flex-1">
            ...
            <View className="bg-slate-50 border border-slate-100 rounded-2xl flex-row items-center px-4 h-16">
                <Text className="flex-1 text-lg font-inter-medium text-text">130</Text>
                <Typography variant="caption" className="ml-2 font-inter-bold opacity-30">mg/dL</Typography>
            </View>
          </View>
        </View>
        ...
        <View className="mb-10">
          ...
          <View className="bg-slate-50 border border-slate-100 rounded-2xl flex-row items-center px-4 h-16">
            <Text className="flex-1 text-lg font-inter-medium text-text">2500</Text>
            <Typography variant="caption" className="ml-2 font-inter-bold opacity-30">ml</Typography>
          </View>
        </View>

        {/* Section: Preferences */}
        <Typography variant="label" className="text-primary font-inter-bold tracking-widest mb-6 border-t border-slate-50 pt-8">
