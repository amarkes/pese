      ...
      <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
        <Card className="mb-5 p-5">
          <View className="mb-4 flex-row items-center">
            <View className="mr-3 h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 dark:bg-blue-950/30">
              <Shield size={22} color={isDarkMode ? '#60A5FA' : '#2563EB'} />
            </View>
        ...
        {sections.map(section => (
          <Card key={section.title} className="mb-5 p-5">
            ...
            <Typography className="text-lg font-outfit-medium text-slate-600 dark:text-slate-300">
              {section.body}
            </Typography>
          </Card>
        ))}
